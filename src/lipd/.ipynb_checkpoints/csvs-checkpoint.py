...
def read_csvs(data_dir):
    ...
    _l = {}
    for filepath in list_files(".csv", path=data_dir):
        filename = os.path.basename(filepath)
        _l[filename] = read_csv_from_file(filepath)
...
def write_csv_to_file(d, data_dir):
    """
        ...
        for filename, data in d.items():
            ...
            try:
                ...
                print("Error: CSV file not written, {}, {}:\n"
                      "The data table may have 2 or more identical variables. Please correct the LiPD file manually".format(filepath, e))
